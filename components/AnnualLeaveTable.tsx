        ...
        <table className="text-xs w-full">
          <thead>
            <tr className="text-left text-blue-900">
              ...
              <th className="pb-1 px-2 font-normal text-right whitespace-nowrap">할당(H)</th>
              <th className="pb-1 px-2 font-normal text-right whitespace-nowrap">사용</th>
              <th className="pb-1 px-2 font-normal whitespace-nowrap">사용일</th>
              <th className="pb-1 px-2 font-normal text-right whitespace-nowrap">잔여(H)</th>
              <th className="pb-1 px-2 font-normal text-right whitespace-nowrap">잔여(D)</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row, i) => (
              ...
              >
                ...
                <td className="py-1 px-2 text-right">{row.usedHoursYear || ""}</td>
                <td className="py-1 px-2 whitespace-nowrap">
                  {row.usedDatesThisMonth.map((d) => `${d}일`).join(", ")}
                </td>
                <td className="py-1 px-2 text-right">{row.remainingHours}</td>
