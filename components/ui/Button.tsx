...
const VARIANT_CLASS: Record<Variant, string> = {
  ...
  secondary: "bg-white text-gray-700 border-gray-200 hover:bg-gray-100 hover:border-gray-300",
...
export default function Button({
  ...
  const base =
    "inline-flex items-center justify-center gap-1 rounded-lg border px-3 py-1.5 text-sm font-medium " +
    "transition-all duration-150 ease-out hover:shadow-sm hover:-translate-y-0.5 " +
